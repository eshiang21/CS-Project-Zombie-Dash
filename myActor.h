...
private:
    void possiblyCreateFlame(double x, double y); //PF
    void landmineExplosion(); //PF
    bool m_setOff;
};
...
public:
    ...
    virtual void dieByFallOrBurnIfAppropriate();
private:
    bool moveTowardsPenelopeIfPossible(Direction dir);
};
...
public:
    ...
    virtual void dieByFallOrBurnIfAppropriate();
private:
    bool isMoveToHumanPossible(Direction dir);
};
